...
@arg_check(ARGS.instructions.save_checkpoint)
@token_required
@error_handler
def save_checkpoint_endpoint(**kwargs):
    """Endpoint to save the checkpoint of a user"""
    ...
    res = InstructionControl.save_checkpoint(**data)
